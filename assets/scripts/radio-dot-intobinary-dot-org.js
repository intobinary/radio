...
//		audioTag.play();
		...
		var canvaTag1 = document.getElementById("canvas");
		canvaTag1.width = window.innerWidth;
		canvaTag1.height = window.innerHeight;
		var ctx = canvaTag1.getContext("2d");
		...
		var WIDTH = canvaTag1.width;
		var HEIGHT = canvaTag1.height;
...
//								radio_playStation(url);
							...
							document.getElementById(stationID).appendChild(img);
...
//						document.getElementById("channelList").appendChild(document.createElement("br"));
			...
			request.open("GET", "channels4.json");
			request.send();
